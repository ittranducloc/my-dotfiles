...
# Stash your environment variables in ~/.localrc. This mean they'll stay out
...
# Path to your dot files
export DOTFILES_ROOT="$HOME/.dotfiles"

# all of your ZSH files
...
# source scripts for tools
typeset -U config_files=($DOTFILES_ROOT/**/*.zsh)
# load source files
for file in ${(M)config_files:#*/source.zsh}
do
  source "$file"
done
